...
:::note
Haven't created a project yet? Check out the [hosting tutorial](/docs/firebase/hosting).
:::
...
Time to point the domain to the new site. [Next Step](setup-the-subdomain)
