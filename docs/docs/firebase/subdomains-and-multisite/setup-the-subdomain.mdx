...
Depending on the TTL of your DNS records and your domain provider, this could take a few minutes to a few hours.

![Verify Domain](img/subdomain-verify.png)

Once the domain is verified, you should be able to see "connected" next to it.

![Connected Domain](img/subdomain-connected.png)

Thats it! Time to deploy your site to the server. [Next step](/docs/firebase/deploy)