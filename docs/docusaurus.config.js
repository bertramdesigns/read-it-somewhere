...
const config = {
  ...
  tagline: 'A collection of things I learned.',
  ...
  organizationName: 'bertramdesigns', // Usually your GitHub org/user name.
  projectName: 'read-it-somewhere', // Usually your repo name.
